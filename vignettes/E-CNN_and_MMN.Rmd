...
**Summary**: The primary bottleneck is system RAM on the CPU, not VRAM on the GPU. To scale further, consider on-the-fly data loaders or distributed training strategies to reduce memory footprint.
