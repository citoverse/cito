...
### Optimizer 
Optimizer are responsible for calculating the direction when updating weights in the training process. The optimizer always tries to minimise the loss function. As standard the adam optimizer will be used. 
