...
output:
 rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Advanced: Custom loss}
...
We can pass custom loss functions to cito. R variables/values that are used within the loss function and that should be additionally optimized must be passed to cito via the custom_parameters function.
